...
export const DonationCard = ({ id, onClose }: DonationCardProps) => {
  ...
  console.log(isWaitingTransaction);
  return (
    <div>
      {isWaitingTransaction && <Loader content='' />}
      <div className='fixed inset-0 z-10 h-100% flex items-center justify-center flex-col'>
        <div className='bg-white w-1/2 h-1/2 border-2 rounded-md p-5 flex-col'>
          <div className='flex justify-end'>
            <button onClick={handleClose} disabled={isWaitingTransaction}>
              <svg
            ...
            <div>
              <form>
                  ...
                  <h1 className='font-semibold'>
                    {form.amount < 500000 ? (
                      <span className='text-red-700'>
                        donation must larger than đ500,000
                      </span>
                    ) : (
                ...
                <Web3Button
                  ...
                  isDisabled={form.amount < 500000 && form.review == ''}
